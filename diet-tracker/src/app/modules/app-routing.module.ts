...
import { AllConsumptionsResolverService } from '../services/resolvers/all-consumptions-resolver.service';
...
const appRoutes: Routes = [
  ...
  { path: '', component: HomeComponent, canActivate: [AuthGuardService], resolve:{macroGoals: MacroGoalResolver}, children: [
    ...
    { path: 'log-history', loadChildren: () => import('./log-history/log-history.module').then(m => m.LogHistoryModule),resolve:{consumptions: AllConsumptionsResolverService} },
